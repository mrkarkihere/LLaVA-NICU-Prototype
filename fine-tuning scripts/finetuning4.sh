...
TRAIN_DATA_PATH=/content/training_dataset.json
EVAL_DATA_PATH=/content/eval_dataset.json
...
VIDEO_FOLDER=/content/drive/MyDrive/Capstone/Videos1
...
MODEL_MAX_LEN=1500                                      # maximum input length of the model
